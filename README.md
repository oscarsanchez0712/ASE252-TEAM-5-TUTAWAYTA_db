...
## Descripcion
Proyecto de base de datos para la gestion de productos derivados de pitahaya,
incluyendo usuarios, pedidos y contacto con clientes.

## Integrantes
- Oscar Heyton Sanchez Arias
- Jorge Luis Vilcapuma Trujillo
- Fabrizio Santiago Jesus Vargas Avendano
